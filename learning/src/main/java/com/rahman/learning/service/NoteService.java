...
public class NoteService {
    ...
    @Autowired
    public NoteRepository setService(NoteRepository noteRepository) {
    ...
    public List<Notes> searchNotesByTitle(String title, int page, int size) {
        try {
            Page<Notes> notesPage = noteRepository.findByTitleContainingIgnoreCase(title, (Pageable) PageRequest.of(page - 1, size));
